	...
	<div class="menu-admin">
		<div class="margins">
			...
			<ul class="menu-a">
				...
				<li><a href="#" style="color: #219ebc">Delete content</a></li>
	...
	<div class="home">
		<div class="margins">
			<div class="add-content">
				...
				<p>Select the type of content you want to delete, and search for and select the corresponding content.</p>
				
				
				<form name="form" action="/OrdClass/DeleteContent" method="post" onsubmit="return checkDeletes()">
				...
				<div class="right">
								...
								<tbody>
									...
									<%for(int i = 0; i<algorithms.size(); i++){
										...
										<tr>
											...
											<td><input type="checkbox" name="al-deletes" value= <%=algorithms.get(i).getId()%> ></td>
										</tr>
								...
								<tbody>
									...
									<%for(int i = 0; i<datasets.size(); i++){
										...
										<tr>
											...
											<td><input type="checkbox" name="ds-deletes" value= <%=datasets.get(i).getId()%> ></td>
										</tr>
								...
								<tbody>
									...
									<%for(int i = 0; i<researches.size(); i++){
										...
										<tr>
											...
											<td><input type="checkbox" name="r-deletes" value= <%=researches.get(i).getId()%> ></td>
										</tr>
								...
								<tbody>
									...
									<%for(int i = 0; i<libraries.size(); i++){
										...
										<tr>
											...
											<td><input type="checkbox" name="l-deletes" value= <%=libraries.get(i).getId()%> ></td>
										</tr>
								...
								<tbody>
									...
									<%for(int i = 0; i<bibliographies.size(); i++){
										...
										<tr>
											...
											<td><input type="checkbox" name="b-deletes" value= <%=bibliographies.get(i).getId()%> ></td>
										</tr>
								...
								<tbody>
									...
									<%for(int i = 0; i<news.size(); i++){
										...
										<tr>
											...
											<td><input type="checkbox" name="n-deletes" value= <%=news.get(i).getId()%> ></td>
										</tr>
					...
					<input type="submit" name="action" value="Delete" class="button-delete">
				</div>
			</div>
			</form>
