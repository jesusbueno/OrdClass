					...
					<div class="right">
						...
						%>
							...
							<div class="column">
								...
								<div class="input-field">
									<input type="number" id="tipo2" name="b-year" placeholder="A�o" min="1900" max="2022" value=<%=bibliography.getYear() %>>
								</div>
							...
							<div class="column">
								...
								<div class="input-field">
									<input type="number" id="tipo2" name="b-number" placeholder="N�mero" min="0" value=<%=bibliography.getNumber() %>>
								</div>
							
								<div class="input-field">
									<input type="text" id="tipo2" name="b-pages" placeholder="P�ginas" value=<%=bibliography.getPages() %>>
								</div>
