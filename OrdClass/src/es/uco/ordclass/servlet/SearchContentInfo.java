...
/**
 * Recibe el id de un contenido en concreto y llama a los DAO para que estos se
 * encarguen de buscar dicha información. Una vez encontrada, redirigen a la
 * página donde se muestra la información. Se utiliza en el modo administrador
 * 
